...
namespace platform
{
  ...
  template<size_t _LocalCaps, typename _CharT, typename _Traits = std::char_traits<_CharT>, 
	  typename _Alloc = std::allocator<_CharT> >
    class __sso_string_base_ex
    : protected __gnu_cxx::__vstring_utility<_CharT, _Traits, _Alloc>
    {
    public:
    ...
    private:
      ...
      enum { _S_local_capacity = _LocalCaps };
	...
	traits_type::assign(_M_data()[__n], _CharT());
      ...
      __sso_string_base_ex()
      : _M_dataplus(_M_local_data)
      { _M_set_length(0); }

      __sso_string_base_ex(const _Alloc& __a);

      __sso_string_base_ex(const __sso_string_base_ex& __rcs);

#if __cplusplus >= 201103L
      __sso_string_base_ex(__sso_string_base_ex&& __rcs);
#endif

      __sso_string_base_ex(size_type __n, _CharT __c, const _Alloc& __a);

      template<typename _InputIterator>
        __sso_string_base_ex(_InputIterator __beg, _InputIterator __end,
			  const _Alloc& __a);
      ...
      void
      _M_swap(__sso_string_base_ex& __rcs);

      void
      _M_assign(const __sso_string_base_ex& __rcs);
      ...
      bool
      _M_compare(const __sso_string_base_ex&) const
      { return false; }
    };

  template<size_t _LocalCaps, typename _CharT, typename _Traits, typename _Alloc>
    void
    __sso_string_base_ex<_LocalCaps, _CharT, _Traits, _Alloc>::
    _M_swap(__sso_string_base_ex& __rcs)
    {
      if (this == &__rcs)
	return;
  ...
  template<size_t _LocalCaps, typename _CharT, typename _Traits, typename _Alloc>
	...
	std::__throw_length_error(__N("__sso_string_base_ex::_M_create"));
  ...
  template<size_t _LocalCaps, typename _CharT, typename _Traits, typename _Alloc>
	...
	if (__gnu_cxx::__is_null_pointer(__beg) && __beg != __end)
	  std::__throw_logic_error(__N("__sso_string_base_ex::"
