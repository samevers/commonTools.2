...
private:
	...
	int32_t MakeIndex_1column( const char *file, const char *index_file, Darts::DoubleArray& da_);
	int32_t OutputIndexFile_1column(std::vector<std::string> & vect,const char * index_file, Darts::DoubleArray& da_);
	int32_t LoadIndex_1column(const char *index_file, Darts::DoubleArray* &da_);
