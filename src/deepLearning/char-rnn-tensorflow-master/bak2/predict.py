...
def sample(args):
    ...
    sys.stdout.write("imageid = %d" % imageid)
    sys.stdout.write("webid = %d" % webid)
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            with open(args.filename, 'r') as f:
              for line in f.readlines():
                ...
                print (line)
                line = line.strip().decode("gbk")
                #print (type(tmp),type(line)) # str,unicode
                #print (type(line), type(args.prime)) # unicode, unicode
                print(model.sample(sess, chars, vocab, args.n, imageid, webid, line, args.sample).encode("gbk"))
